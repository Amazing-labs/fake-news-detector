...
convergent vers *S'authentifier*, et c'est pourquoi les trois rôles sont des
spécialisations d'un utilisateur déjà connecté. Le visiteur est le seul acteur
pour qui *S'authentifier* est un but en soi et non une inclusion : il n'est pas
...
Les étapes s'enchaînent : *Soumettre l'enquête à validation* suppose
*Ouvrir une enquête sur un sujet*, et *Arbitrer une enquête* suppose la
soumission. *Publier un démenti* étend l'arbitrage : c'est un prolongement
facultatif, déclenché seulement lorsqu'une publication déjà diffusée doit être
corrigée. *Contribuer à une enquête* n'est possible que lorsque le directeur a
